...
class User(object):
    ...
    def __init__(self, Id=None, Name=None, FollowCount=None, FollowerCount=None, IsFollow=None, Avatar=None, Message=None, MsgType=None, FavoriteCount=None, WorkCount=None, TotalFavorited=None, BackgroundImage=None, Signature=None,):
        self.Id = Id
        self.Name = Name
...
class DouyinMessageChatRequest(object):
    ...
    def __init__(self, Token=None, ToUserId=None, PreMsgTime=None,):
        self.Token = Token
        self.ToUserId = ToUserId
        self.PreMsgTime = PreMsgTime
